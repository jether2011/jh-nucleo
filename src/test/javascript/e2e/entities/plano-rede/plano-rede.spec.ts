...
import { PlanoRedeComponentsPage, PlanoRedeDeleteDialog, PlanoRedeUpdatePage } from './plano-rede.page-object';
...
describe('PlanoRede e2e test', () => {
  ...
  it('should delete last PlanoRede', async () => {
    ...
    expect(await planoRedeDeleteDialog.getDialogTitle()).to.eq('nucleoApp.planoRede.delete.question');
