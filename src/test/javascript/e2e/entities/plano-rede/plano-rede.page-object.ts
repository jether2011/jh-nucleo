...
export class PlanoRedeComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-plano-rede div table .btn-danger'));
  title = element.all(by.css('jhi-plano-rede div h2#page-heading span')).first();
...
export class PlanoRedeUpdatePage {
  pageTitle = element(by.id('jhi-plano-rede-heading'));
...
export class PlanoRedeDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-planoRede-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-planoRede'));
