...
export class ConsolidacaoComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-consolidacao div table .btn-danger'));
  title = element.all(by.css('jhi-consolidacao div h2#page-heading span')).first();
...
export class ConsolidacaoUpdatePage {
  pageTitle = element(by.id('jhi-consolidacao-heading'));
...
export class ConsolidacaoDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-consolidacao-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-consolidacao'));
