...
export class DescargaUnidadeComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-descarga-unidade div table .btn-danger'));
  title = element.all(by.css('jhi-descarga-unidade div h2#page-heading span')).first();
...
export class DescargaUnidadeUpdatePage {
  pageTitle = element(by.id('jhi-descarga-unidade-heading'));
...
export class DescargaUnidadeDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-descargaUnidade-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-descargaUnidade'));
