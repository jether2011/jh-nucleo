...
export class BoletimPrevisaoUpdatePage {
  ...
  ventosOrigemPontosCardeaisSelect = element(by.id('field_ventosOrigemPontosCardeais'));
  ventoRajadaVentoVmFaixaSelect = element(by.id('field_ventoRajadaVentoVmFaixa'));
  ...
  async ventosOrigemPontosCardeaisSelectLastOption(): Promise<void> {
    await this.ventosOrigemPontosCardeaisSelect.all(by.tagName('option')).last().click();
  }

  async ventosOrigemPontosCardeaisSelectOption(option: string): Promise<void> {
    await this.ventosOrigemPontosCardeaisSelect.sendKeys(option);
  }

  getVentosOrigemPontosCardeaisSelect(): ElementFinder {
    return this.ventosOrigemPontosCardeaisSelect;
  }

  async getVentosOrigemPontosCardeaisSelectedOption(): Promise<string> {
    return await this.ventosOrigemPontosCardeaisSelect.element(by.css('option:checked')).getText();
  }

  async ventoRajadaVentoVmFaixaSelectLastOption(): Promise<void> {
    await this.ventoRajadaVentoVmFaixaSelect.all(by.tagName('option')).last().click();
  }

  async ventoRajadaVentoVmFaixaSelectOption(option: string): Promise<void> {
    await this.ventoRajadaVentoVmFaixaSelect.sendKeys(option);
  }

  getVentoRajadaVentoVmFaixaSelect(): ElementFinder {
    return this.ventoRajadaVentoVmFaixaSelect;
  }

  async getVentoRajadaVentoVmFaixaSelectedOption(): Promise<string> {
    return await this.ventoRajadaVentoVmFaixaSelect.element(by.css('option:checked')).getText();
  }
