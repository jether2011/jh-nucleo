...
export class NoticiaComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-noticia div table .btn-danger'));
  title = element.all(by.css('jhi-noticia div h2#page-heading span')).first();
...
export class NoticiaUpdatePage {
  pageTitle = element(by.id('jhi-noticia-heading'));
...
export class NoticiaDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-noticia-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-noticia'));
