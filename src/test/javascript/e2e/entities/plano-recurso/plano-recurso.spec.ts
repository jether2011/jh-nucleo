...
import {
  PlanoRecursoComponentsPage,
  /* PlanoRecursoDeleteDialog, */
  PlanoRecursoUpdatePage,
} from './plano-recurso.page-object';
...
describe('PlanoRecurso e2e test', () => {
  ...
  /* it('should create and save PlanoRecursos', async () => {
        ...
        expect(await planoRecursoUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
        expect(await planoRecursoUpdatePage.getUpdatedInput()).to.contain('2001-01-01T02:30', 'Expected updated value to be equals to 2000-12-31');
  ...
  /* it('should delete last PlanoRecurso', async () => {
        ...
        expect(await planoRecursoDeleteDialog.getDialogTitle())
            .to.eq('nucleoApp.planoRecurso.delete.question');
