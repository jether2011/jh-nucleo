...
import { JornadaTrabalhoComponentsPage, JornadaTrabalhoDeleteDialog, JornadaTrabalhoUpdatePage } from './jornada-trabalho.page-object';
...
describe('JornadaTrabalho e2e test', () => {
  ...
  it('should create and save JornadaTrabalhos', async () => {
    ...
    expect(await jornadaTrabalhoUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await jornadaTrabalhoUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await jornadaTrabalhoComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last JornadaTrabalho', async () => {
    ...
    expect(await jornadaTrabalhoDeleteDialog.getDialogTitle()).to.eq('nucleoApp.jornadaTrabalho.delete.question');
