...
import { AlertaFerramentaComponentsPage, AlertaFerramentaDeleteDialog, AlertaFerramentaUpdatePage } from './alerta-ferramenta.page-object';
...
describe('AlertaFerramenta e2e test', () => {
  ...
  it('should create and save AlertaFerramentas', async () => {
    ...
    expect(await alertaFerramentaUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await alertaFerramentaUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await alertaFerramentaComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last AlertaFerramenta', async () => {
    ...
    expect(await alertaFerramentaDeleteDialog.getDialogTitle()).to.eq('nucleoApp.alertaFerramenta.delete.question');
