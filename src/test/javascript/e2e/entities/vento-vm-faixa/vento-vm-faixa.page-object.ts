...
export class VentoVmFaixaComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-vento-vm-faixa div table .btn-danger'));
  title = element.all(by.css('jhi-vento-vm-faixa div h2#page-heading span')).first();
...
export class VentoVmFaixaUpdatePage {
  pageTitle = element(by.id('jhi-vento-vm-faixa-heading'));
...
export class VentoVmFaixaDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-ventoVmFaixa-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-ventoVmFaixa'));
