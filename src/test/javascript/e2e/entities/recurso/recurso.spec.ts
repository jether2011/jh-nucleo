...
import { RecursoComponentsPage, RecursoDeleteDialog, RecursoUpdatePage } from './recurso.page-object';
...
describe('Recurso e2e test', () => {
  ...
  it('should delete last Recurso', async () => {
    ...
    expect(await recursoDeleteDialog.getDialogTitle()).to.eq('nucleoApp.recurso.delete.question');
