...
describe('ContatoPlanoRecurso e2e test', () => {
  ...
  it('should create and save ContatoPlanoRecursos', async () => {
    ...
    expect(await contatoPlanoRecursoUpdatePage.getDescricaoInput()).to.eq(
      'descricao',
      'Expected Descricao value to be equals to descricao'
    );
    expect(await contatoPlanoRecursoUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await contatoPlanoRecursoUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await contatoPlanoRecursoComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last ContatoPlanoRecurso', async () => {
    ...
    expect(await contatoPlanoRecursoDeleteDialog.getDialogTitle()).to.eq('nucleoApp.contatoPlanoRecurso.delete.question');
