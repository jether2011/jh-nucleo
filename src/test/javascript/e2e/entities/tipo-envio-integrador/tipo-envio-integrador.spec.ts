...
describe('TipoEnvioIntegrador e2e test', () => {
  ...
  it('should create and save TipoEnvioIntegradors', async () => {
    ...
    expect(await tipoEnvioIntegradorUpdatePage.getDescricaoInput()).to.eq(
      'descricao',
    ...
    expect(await tipoEnvioIntegradorUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await tipoEnvioIntegradorUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await tipoEnvioIntegradorComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last TipoEnvioIntegrador', async () => {
    ...
    expect(await tipoEnvioIntegradorDeleteDialog.getDialogTitle()).to.eq('nucleoApp.tipoEnvioIntegrador.delete.question');
