...
export class TempestadeProbabilidadeComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-tempestade-probabilidade div table .btn-danger'));
  title = element.all(by.css('jhi-tempestade-probabilidade div h2#page-heading span')).first();
...
export class TempestadeProbabilidadeUpdatePage {
  pageTitle = element(by.id('jhi-tempestade-probabilidade-heading'));
...
export class TempestadeProbabilidadeDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tempestadeProbabilidade-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tempestadeProbabilidade'));
