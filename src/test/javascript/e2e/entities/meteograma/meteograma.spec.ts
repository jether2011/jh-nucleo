...
import { MeteogramaComponentsPage, MeteogramaDeleteDialog, MeteogramaUpdatePage } from './meteograma.page-object';
...
describe('Meteograma e2e test', () => {
  ...
  it('should create and save Meteogramas', async () => {
    ...
    expect(await meteogramaUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await meteogramaUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
  ...
  it('should delete last Meteograma', async () => {
    ...
    expect(await meteogramaDeleteDialog.getDialogTitle()).to.eq('nucleoApp.meteograma.delete.question');
