...
describe('AvisoMeteorologico e2e test', () => {
  ...
  /* it('should create and save AvisoMeteorologicos', async () => {
        ...
        expect(await avisoMeteorologicoUpdatePage.getInicioInput()).to.contain('2001-01-01T02:30', 'Expected inicio value to be equals to 2000-12-31');
        expect(await avisoMeteorologicoUpdatePage.getFimInput()).to.contain('2001-01-01T02:30', 'Expected fim value to be equals to 2000-12-31');
        ...
        expect(await avisoMeteorologicoUpdatePage.getImagemAssinaturaInput()).to.eq('imagemAssinatura', 'Expected ImagemAssinatura value to be equals to imagemAssinatura');
        expect(await avisoMeteorologicoUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
        expect(await avisoMeteorologicoUpdatePage.getUpdatedInput()).to.contain('2001-01-01T02:30', 'Expected updated value to be equals to 2000-12-31');
        ...
        expect(await avisoMeteorologicoComponentsPage.countDeleteButtons()).to.eq(nbButtonsBeforeCreate + 1, 'Expected one more entry in the table');
    }); */
  ...
  /* it('should delete last AvisoMeteorologico', async () => {
        ...
        expect(await avisoMeteorologicoDeleteDialog.getDialogTitle())
            .to.eq('nucleoApp.avisoMeteorologico.delete.question');
