...
import { UsuarioPerfilComponentsPage, UsuarioPerfilDeleteDialog, UsuarioPerfilUpdatePage } from './usuario-perfil.page-object';
...
describe('UsuarioPerfil e2e test', () => {
  ...
  it('should create and save UsuarioPerfils', async () => {
    ...
    expect(await usuarioPerfilUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await usuarioPerfilUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
  ...
  it('should delete last UsuarioPerfil', async () => {
    ...
    expect(await usuarioPerfilDeleteDialog.getDialogTitle()).to.eq('nucleoApp.usuarioPerfil.delete.question');
