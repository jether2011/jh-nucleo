...
import { ContatoTipoEnvioComponentsPage, ContatoTipoEnvioDeleteDialog, ContatoTipoEnvioUpdatePage } from './contato-tipo-envio.page-object';
...
describe('ContatoTipoEnvio e2e test', () => {
  ...
  it('should create and save ContatoTipoEnvios', async () => {
    ...
    expect(await contatoTipoEnvioUpdatePage.getCreatedInput()).to.contain(
      '2001-01-01T02:30',
      'Expected created value to be equals to 2000-12-31'
    );
    expect(await contatoTipoEnvioUpdatePage.getUpdatedInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await contatoTipoEnvioComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last ContatoTipoEnvio', async () => {
    ...
    expect(await contatoTipoEnvioDeleteDialog.getDialogTitle()).to.eq('nucleoApp.contatoTipoEnvio.delete.question');
