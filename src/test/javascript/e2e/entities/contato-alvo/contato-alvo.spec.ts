...
import {
  ContatoAlvoComponentsPage,
  /* ContatoAlvoDeleteDialog, */
  ContatoAlvoUpdatePage,
} from './contato-alvo.page-object';
...
describe('ContatoAlvo e2e test', () => {
  ...
  /* it('should create and save ContatoAlvos', async () => {
        ...
        expect(await contatoAlvoUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
        expect(await contatoAlvoUpdatePage.getUpdatedInput()).to.contain('2001-01-01T02:30', 'Expected updated value to be equals to 2000-12-31');
  ...
  /* it('should delete last ContatoAlvo', async () => {
        ...
        expect(await contatoAlvoDeleteDialog.getDialogTitle())
            .to.eq('nucleoApp.contatoAlvo.delete.question');
