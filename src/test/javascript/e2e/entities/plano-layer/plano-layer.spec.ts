...
import {
  PlanoLayerComponentsPage,
  /* PlanoLayerDeleteDialog, */
  PlanoLayerUpdatePage,
} from './plano-layer.page-object';
...
describe('PlanoLayer e2e test', () => {
  ...
  /* it('should create and save PlanoLayers', async () => {
        ...
        expect(await planoLayerUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
        expect(await planoLayerUpdatePage.getUpdatedInput()).to.contain('2001-01-01T02:30', 'Expected updated value to be equals to 2000-12-31');
  ...
  /* it('should delete last PlanoLayer', async () => {
        ...
        expect(await planoLayerDeleteDialog.getDialogTitle())
            .to.eq('nucleoApp.planoLayer.delete.question');
