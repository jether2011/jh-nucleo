...
import {
  PlanoUsuarioComponentsPage,
  /* PlanoUsuarioDeleteDialog, */
  PlanoUsuarioUpdatePage,
} from './plano-usuario.page-object';
...
describe('PlanoUsuario e2e test', () => {
  ...
  /* it('should create and save PlanoUsuarios', async () => {
        ...
        await promise.all([
            ...
            planoUsuarioUpdatePage.idSelectLastOption(),
        ...
        expect(await planoUsuarioUpdatePage.getCreatedInput()).to.contain('2001-01-01T02:30', 'Expected created value to be equals to 2000-12-31');
        expect(await planoUsuarioUpdatePage.getUpdatedInput()).to.contain('2001-01-01T02:30', 'Expected updated value to be equals to 2000-12-31');
  ...
  /* it('should delete last PlanoUsuario', async () => {
        ...
        expect(await planoUsuarioDeleteDialog.getDialogTitle())
            .to.eq('nucleoApp.planoUsuario.delete.question');
