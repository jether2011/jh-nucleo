...
describe('Service Tests', () => {
  describe('Alerta Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(AlertaService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Alerta(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false, false, 'AAAAAAA', 0, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Alerta', () => {
        ...
        service.create(new Alerta()).subscribe(resp => (expectedResult = resp.body));
