...
import { AlertaComponent } from 'app/entities/alerta/alerta.component';
  ...
  describe('Alerta Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlertaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alertas && comp.alertas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
