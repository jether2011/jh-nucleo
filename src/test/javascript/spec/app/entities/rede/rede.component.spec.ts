...
import { RedeComponent } from 'app/entities/rede/rede.component';
import { RedeService } from 'app/entities/rede/rede.service';
import { Rede } from 'app/shared/model/rede.model';

describe('Component Tests', () => {
  describe('Rede Management Component', () => {
    let comp: RedeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RedeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.redes && comp.redes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
