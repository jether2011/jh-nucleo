...
import { IntegradorComponent } from 'app/entities/integrador/integrador.component';
...
describe('Component Tests', () => {
  describe('Integrador Management Component', () => {
    let comp: IntegradorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IntegradorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.integradors && comp.integradors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
