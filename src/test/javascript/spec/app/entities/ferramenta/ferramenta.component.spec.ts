...
import { FerramentaComponent } from 'app/entities/ferramenta/ferramenta.component';
...
describe('Component Tests', () => {
  describe('Ferramenta Management Component', () => {
    let comp: FerramentaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FerramentaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ferramentas && comp.ferramentas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
