...
import { PrevisaoComponent } from 'app/entities/previsao/previsao.component';
...
describe('Component Tests', () => {
  describe('Previsao Management Component', () => {
    let comp: PrevisaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrevisaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.previsaos && comp.previsaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
