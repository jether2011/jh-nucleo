...
import { InformativoComponent } from 'app/entities/informativo/informativo.component';
...
describe('Component Tests', () => {
  describe('Informativo Management Component', () => {
    let comp: InformativoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InformativoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.informativos && comp.informativos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
