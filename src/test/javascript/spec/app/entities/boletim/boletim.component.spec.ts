...
import { BoletimComponent } from 'app/entities/boletim/boletim.component';
import { BoletimService } from 'app/entities/boletim/boletim.service';
import { Boletim } from 'app/shared/model/boletim.model';

describe('Component Tests', () => {
  describe('Boletim Management Component', () => {
    let comp: BoletimComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BoletimComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.boletims && comp.boletims[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
