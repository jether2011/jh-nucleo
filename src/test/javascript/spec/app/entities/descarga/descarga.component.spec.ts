...
import { DescargaComponent } from 'app/entities/descarga/descarga.component';
...
describe('Component Tests', () => {
  describe('Descarga Management Component', () => {
    let comp: DescargaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DescargaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.descargas && comp.descargas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
