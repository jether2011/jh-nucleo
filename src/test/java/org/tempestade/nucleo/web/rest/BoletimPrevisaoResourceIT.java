...
public class BoletimPrevisaoResourceIT {
    ...
    public static BoletimPrevisao createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, IntensidadeChuva.class).isEmpty()) {
            intensidadeChuva = IntensidadeChuvaResourceIT.createEntity(em);
            em.persist(intensidadeChuva);
            em.flush();
        } else {
            intensidadeChuva = TestUtil.findAll(em, IntensidadeChuva.class).get(0);
        }
    ...
    public static BoletimPrevisao createUpdatedEntity(EntityManager em) {
        ...
        IntensidadeChuva intensidadeChuva;
        if (TestUtil.findAll(em, IntensidadeChuva.class).isEmpty()) {
            intensidadeChuva = IntensidadeChuvaResourceIT.createUpdatedEntity(em);
            em.persist(intensidadeChuva);
            em.flush();
        } else {
            intensidadeChuva = TestUtil.findAll(em, IntensidadeChuva.class).get(0);
    ...
    public void getAllBoletimPrevisaosByIntensidadeChuvaIsEqualToSomething() throws Exception {
        ...
        IntensidadeChuva intensidadeChuva = boletimPrevisao.getIntensidadeChuva();
        boletimPrevisaoRepository.saveAndFlush(boletimPrevisao);
    ...
    @Test
    @Transactional
    public void getAllBoletimPrevisaosByVentosOrigemPontosCardeaisIsEqualToSomething() throws Exception {
        // Initialize the database
        boletimPrevisaoRepository.saveAndFlush(boletimPrevisao);
        PontosCardeais ventosOrigemPontosCardeais = PontosCardeaisResourceIT.createEntity(em);
        em.persist(ventosOrigemPontosCardeais);
        em.flush();
        boletimPrevisao.setVentosOrigemPontosCardeais(ventosOrigemPontosCardeais);
        boletimPrevisaoRepository.saveAndFlush(boletimPrevisao);
        Long ventosOrigemPontosCardeaisId = ventosOrigemPontosCardeais.getId();

        // Get all the boletimPrevisaoList where ventosOrigemPontosCardeais equals to ventosOrigemPontosCardeaisId
        defaultBoletimPrevisaoShouldBeFound("ventosOrigemPontosCardeaisId.equals=" + ventosOrigemPontosCardeaisId);

        // Get all the boletimPrevisaoList where ventosOrigemPontosCardeais equals to ventosOrigemPontosCardeaisId + 1
        defaultBoletimPrevisaoShouldNotBeFound("ventosOrigemPontosCardeaisId.equals=" + (ventosOrigemPontosCardeaisId + 1));
    }


    @Test
    @Transactional
    public void getAllBoletimPrevisaosByVentoRajadaVentoVmFaixaIsEqualToSomething() throws Exception {
        // Initialize the database
        boletimPrevisaoRepository.saveAndFlush(boletimPrevisao);
        VentoVmFaixa ventoRajadaVentoVmFaixa = VentoVmFaixaResourceIT.createEntity(em);
        em.persist(ventoRajadaVentoVmFaixa);
        em.flush();
        boletimPrevisao.setVentoRajadaVentoVmFaixa(ventoRajadaVentoVmFaixa);
        boletimPrevisaoRepository.saveAndFlush(boletimPrevisao);
        Long ventoRajadaVentoVmFaixaId = ventoRajadaVentoVmFaixa.getId();

        // Get all the boletimPrevisaoList where ventoRajadaVentoVmFaixa equals to ventoRajadaVentoVmFaixaId
        defaultBoletimPrevisaoShouldBeFound("ventoRajadaVentoVmFaixaId.equals=" + ventoRajadaVentoVmFaixaId);

        // Get all the boletimPrevisaoList where ventoRajadaVentoVmFaixa equals to ventoRajadaVentoVmFaixaId + 1
        defaultBoletimPrevisaoShouldNotBeFound("ventoRajadaVentoVmFaixaId.equals=" + (ventoRajadaVentoVmFaixaId + 1));
    }
