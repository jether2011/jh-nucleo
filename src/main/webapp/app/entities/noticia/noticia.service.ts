...
export class NoticiaService {
  public resourceUrl = SERVER_API_URL + 'api/noticias';
  ...
  protected convertDateFromClient(noticia: INoticia): INoticia {
    const copy: INoticia = Object.assign({}, noticia, {
      created: noticia.created && noticia.created.isValid() ? noticia.created.toJSON() : undefined,
      updated: noticia.updated && noticia.updated.isValid() ? noticia.updated.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((noticia: INoticia) => {
        noticia.created = noticia.created ? moment(noticia.created) : undefined;
        noticia.updated = noticia.updated ? moment(noticia.updated) : undefined;
      });
    }
    return res;
  }
