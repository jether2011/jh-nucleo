...
export class BoletimPrevisaoUpdateComponent implements OnInit {
  ...
  updateForm(boletimPrevisao: IBoletimPrevisao): void {
    this.editForm.patchValue({
      ...
      pontosCardeaisId: boletimPrevisao.pontosCardeaisId,
      ventoVmFaixaId: boletimPrevisao.ventoVmFaixaId,
  ...
  private createFromForm(): IBoletimPrevisao {
    return {
      ...
      pontosCardeaisId: this.editForm.get(['pontosCardeaisId'])!.value,
      ventoVmFaixaId: this.editForm.get(['ventoVmFaixaId'])!.value,
