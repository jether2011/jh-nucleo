...
export class ContatoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contatoService
      ...
      .subscribe(
        (res: HttpResponse<IContato[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInContatoes(): void {
    this.eventSubscriber = this.eventManager.subscribe('contatoListModification', () => this.loadPage());
  }
