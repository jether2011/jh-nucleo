...
export class RecursoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.recursoService
      ...
      .subscribe(
        (res: HttpResponse<IRecurso[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInRecursos(): void {
    this.eventSubscriber = this.eventManager.subscribe('recursoListModification', () => this.loadPage());
  }
