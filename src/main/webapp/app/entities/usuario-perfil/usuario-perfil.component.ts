...
export class UsuarioPerfilComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.usuarioPerfilService
      ...
      .subscribe(
        (res: HttpResponse<IUsuarioPerfil[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IUsuarioPerfil): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInUsuarioPerfils(): void {
    this.eventSubscriber = this.eventManager.subscribe('usuarioPerfilListModification', () => this.loadPage());
  }

  delete(usuarioPerfil: IUsuarioPerfil): void {
  ...
  protected onSuccess(data: IUsuarioPerfil[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
