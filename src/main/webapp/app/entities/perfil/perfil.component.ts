...
export class PerfilComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.perfilService
      ...
      .subscribe(
        (res: HttpResponse<IPerfil[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPerfils(): void {
    this.eventSubscriber = this.eventManager.subscribe('perfilListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPerfil[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
