...
@Repository
public interface TempestadeProbabilidadeRepository extends JpaRepository<TempestadeProbabilidade, Long>, JpaSpecificationExecutor<TempestadeProbabilidade> {
}
