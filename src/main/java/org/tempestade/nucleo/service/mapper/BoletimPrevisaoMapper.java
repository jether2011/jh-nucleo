...
public interface BoletimPrevisaoMapper extends EntityMapper<BoletimPrevisaoDTO, BoletimPrevisao> {
    ...
    @Mapping(source = "pontosCardeais.id", target = "pontosCardeaisId")
    @Mapping(source = "ventoVmFaixa.id", target = "ventoVmFaixaId")
    ...
    @Mapping(source = "pontosCardeaisId", target = "pontosCardeais")
    @Mapping(source = "ventoVmFaixaId", target = "ventoVmFaixa")
