...
/**
 * Criteria class for the {@link org.tempestade.nucleo.domain.Informativo} entity. This class is used
 * in {@link org.tempestade.nucleo.web.rest.InformativoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /informativos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class InformativoCriteria implements Serializable, Criteria {
    ...
    public InformativoCriteria() {
    }

    public InformativoCriteria(InformativoCriteria other) {
    ...
    @Override
    public InformativoCriteria copy() {
        return new InformativoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InformativoCriteria that = (InformativoCriteria) o;
        return
