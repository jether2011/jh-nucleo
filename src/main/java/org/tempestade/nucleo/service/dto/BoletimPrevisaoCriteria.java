...
public class BoletimPrevisaoCriteria implements Serializable, Criteria {
    ...
    private LongFilter ventosOrigemPontosCardeaisId;

    private LongFilter ventoRajadaVentoVmFaixaId;
    ...
    public BoletimPrevisaoCriteria(BoletimPrevisaoCriteria other) {
        ...
        this.ventosOrigemPontosCardeaisId = other.ventosOrigemPontosCardeaisId == null ? null : other.ventosOrigemPontosCardeaisId.copy();
        this.ventoRajadaVentoVmFaixaId = other.ventoRajadaVentoVmFaixaId == null ? null : other.ventoRajadaVentoVmFaixaId.copy();
    ...
    public LongFilter getVentosOrigemPontosCardeaisId() {
        return ventosOrigemPontosCardeaisId;
    }

    public void setVentosOrigemPontosCardeaisId(LongFilter ventosOrigemPontosCardeaisId) {
        this.ventosOrigemPontosCardeaisId = ventosOrigemPontosCardeaisId;
    }

    public LongFilter getVentoRajadaVentoVmFaixaId() {
        return ventoRajadaVentoVmFaixaId;
    }

    public void setVentoRajadaVentoVmFaixaId(LongFilter ventoRajadaVentoVmFaixaId) {
        this.ventoRajadaVentoVmFaixaId = ventoRajadaVentoVmFaixaId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(ventosOrigemPontosCardeaisId, that.ventosOrigemPontosCardeaisId) &&
            Objects.equals(ventoRajadaVentoVmFaixaId, that.ventoRajadaVentoVmFaixaId) &&
    ...
    public String toString() {
        return "BoletimPrevisaoCriteria{" +
                ...
                (ventosOrigemPontosCardeaisId != null ? "ventosOrigemPontosCardeaisId=" + ventosOrigemPontosCardeaisId + ", " : "") +
                (ventoRajadaVentoVmFaixaId != null ? "ventoRajadaVentoVmFaixaId=" + ventoRajadaVentoVmFaixaId + ", " : "") +
