...
public class BoletimPrevisaoDTO implements Serializable {
    ...
    private Long pontosCardeaisId;

    private Long ventoVmFaixaId;
    ...
    public Long getPontosCardeaisId() {
        return pontosCardeaisId;
    }

    public void setPontosCardeaisId(Long pontosCardeaisId) {
        this.pontosCardeaisId = pontosCardeaisId;
    }

    public Long getVentoVmFaixaId() {
        return ventoVmFaixaId;
    }

    public void setVentoVmFaixaId(Long ventoVmFaixaId) {
    ...
    public String toString() {
        return "BoletimPrevisaoDTO{" +
            ...
            ", alvoId=" + getAlvoId() +
            ", pontosCardeaisId=" + getPontosCardeaisId() +
            ", ventoVmFaixaId=" + getVentoVmFaixaId() +
