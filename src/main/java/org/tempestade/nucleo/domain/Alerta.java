...
public class Alerta implements Serializable {
    ...
    public Usuario getOperadorUsuario() {
        return operadorUsuario;
    }

    public Alerta operadorUsuario(Usuario usuario) {
        this.operadorUsuario = usuario;
        return this;
    }

    public void setOperadorUsuario(Usuario usuario) {
        this.operadorUsuario = usuario;
    }
