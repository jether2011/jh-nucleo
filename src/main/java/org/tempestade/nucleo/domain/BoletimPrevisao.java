...
public class BoletimPrevisao implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "condicao_tempo", length = 255)
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "boletimPrevisaos", allowSetters = true)
    private PontosCardeais ventosOrigemPontosCardeais;

    @ManyToOne
    @JsonIgnoreProperties(value = "boletimPrevisaos", allowSetters = true)
    private VentoVmFaixa ventoRajadaVentoVmFaixa;
    ...
    public BoletimPrevisao condicaoTempo(String condicaoTempo) {
    ...
    public PontosCardeais getVentosOrigemPontosCardeais() {
        return ventosOrigemPontosCardeais;
    }

    public BoletimPrevisao ventosOrigemPontosCardeais(PontosCardeais pontosCardeais) {
        this.ventosOrigemPontosCardeais = pontosCardeais;
        return this;
    }

    public void setVentosOrigemPontosCardeais(PontosCardeais pontosCardeais) {
        this.ventosOrigemPontosCardeais = pontosCardeais;
    }

    public VentoVmFaixa getVentoRajadaVentoVmFaixa() {
        return ventoRajadaVentoVmFaixa;
    }

    public BoletimPrevisao ventoRajadaVentoVmFaixa(VentoVmFaixa ventoVmFaixa) {
        this.ventoRajadaVentoVmFaixa = ventoVmFaixa;
        return this;
    }

    public void setVentoRajadaVentoVmFaixa(VentoVmFaixa ventoVmFaixa) {
        this.ventoRajadaVentoVmFaixa = ventoVmFaixa;
    }
