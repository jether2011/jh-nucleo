...
public class PlanoRecursoTipoEnvioResource {
    ...
    public PlanoRecursoTipoEnvioResource(PlanoRecursoTipoEnvioService planoRecursoTipoEnvioService) {
    ...
    public ResponseEntity<List<PlanoRecursoTipoEnvioDTO>> getAllPlanoRecursoTipoEnvios(Pageable pageable) {
        log.debug("REST request to get a page of PlanoRecursoTipoEnvios");
        Page<PlanoRecursoTipoEnvioDTO> page = planoRecursoTipoEnvioService.findAll(pageable);
