...
public class AlertaResource {
    ...
    public AlertaResource(AlertaService alertaService, AlertaQueryService alertaQueryService) {
     ...
     */
    @GetMapping("/alertas")
    public ResponseEntity<List<AlertaDTO>> getAllAlertas(AlertaCriteria criteria, Pageable pageable) {
