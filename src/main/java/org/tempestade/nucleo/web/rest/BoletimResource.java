...
public class BoletimResource {
    ...
    public BoletimResource(BoletimService boletimService) {
     ...
     */
    @GetMapping("/boletims")
    public ResponseEntity<List<BoletimDTO>> getAllBoletims(Pageable pageable) {
        log.debug("REST request to get a page of Boletims");
        Page<BoletimDTO> page = boletimService.findAll(pageable);
