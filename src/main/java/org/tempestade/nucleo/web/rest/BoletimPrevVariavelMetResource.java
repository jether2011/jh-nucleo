...
public class BoletimPrevVariavelMetResource {
    ...
    public BoletimPrevVariavelMetResource(BoletimPrevVariavelMetService boletimPrevVariavelMetService) {
    ...
    public ResponseEntity<List<BoletimPrevVariavelMetDTO>> getAllBoletimPrevVariavelMets(Pageable pageable) {
        log.debug("REST request to get a page of BoletimPrevVariavelMets");
        Page<BoletimPrevVariavelMetDTO> page = boletimPrevVariavelMetService.findAll(pageable);
