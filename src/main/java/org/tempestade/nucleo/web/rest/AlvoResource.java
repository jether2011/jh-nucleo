...
public class AlvoResource {
    ...
    public AlvoResource(AlvoService alvoService) {
     ...
     */
    @GetMapping("/alvos")
    public ResponseEntity<List<AlvoDTO>> getAllAlvos(Pageable pageable) {
        log.debug("REST request to get a page of Alvos");
        Page<AlvoDTO> page = alvoService.findAll(pageable);
