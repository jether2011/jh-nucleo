...
public class ContatoPlanoRecursoResource {
    ...
    public ContatoPlanoRecursoResource(ContatoPlanoRecursoService contatoPlanoRecursoService) {
    ...
    public ResponseEntity<List<ContatoPlanoRecursoDTO>> getAllContatoPlanoRecursos(Pageable pageable) {
        log.debug("REST request to get a page of ContatoPlanoRecursos");
        Page<ContatoPlanoRecursoDTO> page = contatoPlanoRecursoService.findAll(pageable);
