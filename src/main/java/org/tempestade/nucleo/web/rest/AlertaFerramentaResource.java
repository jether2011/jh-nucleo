...
public class AlertaFerramentaResource {
    ...
    public AlertaFerramentaResource(AlertaFerramentaService alertaFerramentaService) {
    ...
    public ResponseEntity<List<AlertaFerramentaDTO>> getAllAlertaFerramentas(Pageable pageable) {
        log.debug("REST request to get a page of AlertaFerramentas");
        Page<AlertaFerramentaDTO> page = alertaFerramentaService.findAll(pageable);
