...
public class RecursoTemplateResource {
    ...
    public RecursoTemplateResource(RecursoTemplateService recursoTemplateService) {
    ...
    public ResponseEntity<List<RecursoTemplateDTO>> getAllRecursoTemplates(Pageable pageable) {
        log.debug("REST request to get a page of RecursoTemplates");
        Page<RecursoTemplateDTO> page = recursoTemplateService.findAll(pageable);
