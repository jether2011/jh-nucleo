...
public class PlanoUsuarioResource {
    ...
    public PlanoUsuarioResource(PlanoUsuarioService planoUsuarioService) {
    ...
    public ResponseEntity<List<PlanoUsuarioDTO>> getAllPlanoUsuarios(Pageable pageable) {
        log.debug("REST request to get a page of PlanoUsuarios");
        Page<PlanoUsuarioDTO> page = planoUsuarioService.findAll(pageable);
