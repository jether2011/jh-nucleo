...
public class ConsolidacaoResource {
    ...
    public ConsolidacaoResource(ConsolidacaoService consolidacaoService) {
    ...
    public ResponseEntity<List<ConsolidacaoDTO>> getAllConsolidacaos(Pageable pageable) {
        log.debug("REST request to get a page of Consolidacaos");
        Page<ConsolidacaoDTO> page = consolidacaoService.findAll(pageable);
