...
public class PlanoRecursoResource {
    ...
    public PlanoRecursoResource(PlanoRecursoService planoRecursoService) {
    ...
    public ResponseEntity<List<PlanoRecursoDTO>> getAllPlanoRecursos(Pageable pageable) {
        log.debug("REST request to get a page of PlanoRecursos");
        Page<PlanoRecursoDTO> page = planoRecursoService.findAll(pageable);
