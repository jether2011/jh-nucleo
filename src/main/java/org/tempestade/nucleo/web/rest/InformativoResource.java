...
public class InformativoResource {
    ...
    public InformativoResource(InformativoService informativoService) {
    ...
    public ResponseEntity<List<InformativoDTO>> getAllInformativos(Pageable pageable) {
        log.debug("REST request to get a page of Informativos");
        Page<InformativoDTO> page = informativoService.findAll(pageable);
