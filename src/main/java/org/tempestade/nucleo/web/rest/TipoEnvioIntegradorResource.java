...
public class TipoEnvioIntegradorResource {
    ...
    public TipoEnvioIntegradorResource(TipoEnvioIntegradorService tipoEnvioIntegradorService) {
    ...
    public ResponseEntity<List<TipoEnvioIntegradorDTO>> getAllTipoEnvioIntegradors(Pageable pageable) {
        log.debug("REST request to get a page of TipoEnvioIntegradors");
        Page<TipoEnvioIntegradorDTO> page = tipoEnvioIntegradorService.findAll(pageable);
