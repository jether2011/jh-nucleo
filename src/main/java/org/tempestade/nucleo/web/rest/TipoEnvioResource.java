...
public class TipoEnvioResource {
    ...
    public TipoEnvioResource(TipoEnvioService tipoEnvioService) {
    ...
    public ResponseEntity<List<TipoEnvioDTO>> getAllTipoEnvios(Pageable pageable) {
        log.debug("REST request to get a page of TipoEnvios");
        Page<TipoEnvioDTO> page = tipoEnvioService.findAll(pageable);
