...
public class AvisoTipoResource {
    ...
    public AvisoTipoResource(AvisoTipoService avisoTipoService) {
    ...
    public ResponseEntity<List<AvisoTipoDTO>> getAllAvisoTipos(Pageable pageable) {
        log.debug("REST request to get a page of AvisoTipos");
        Page<AvisoTipoDTO> page = avisoTipoService.findAll(pageable);
