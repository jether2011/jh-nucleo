...
public class AlertaRiscoResource {
    ...
    public AlertaRiscoResource(AlertaRiscoService alertaRiscoService) {
    ...
    public ResponseEntity<List<AlertaRiscoDTO>> getAllAlertaRiscos(Pageable pageable) {
        log.debug("REST request to get a page of AlertaRiscos");
        Page<AlertaRiscoDTO> page = alertaRiscoService.findAll(pageable);
