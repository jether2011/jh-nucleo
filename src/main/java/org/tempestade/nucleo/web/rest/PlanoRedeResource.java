...
public class PlanoRedeResource {
    ...
    public PlanoRedeResource(PlanoRedeService planoRedeService) {
    ...
    public ResponseEntity<List<PlanoRedeDTO>> getAllPlanoRedes(Pageable pageable) {
        log.debug("REST request to get a page of PlanoRedes");
        Page<PlanoRedeDTO> page = planoRedeService.findAll(pageable);
