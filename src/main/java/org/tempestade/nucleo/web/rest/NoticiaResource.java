...
public class NoticiaResource {
    ...
    public NoticiaResource(NoticiaService noticiaService, NoticiaQueryService noticiaQueryService) {
     ...
     */
    @GetMapping("/noticias")
    public ResponseEntity<List<NoticiaDTO>> getAllNoticias(NoticiaCriteria criteria, Pageable pageable) {
