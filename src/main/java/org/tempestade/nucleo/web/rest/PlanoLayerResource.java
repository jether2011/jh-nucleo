...
public class PlanoLayerResource {
    ...
    public PlanoLayerResource(PlanoLayerService planoLayerService) {
    ...
    public ResponseEntity<List<PlanoLayerDTO>> getAllPlanoLayers(Pageable pageable) {
        log.debug("REST request to get a page of PlanoLayers");
        Page<PlanoLayerDTO> page = planoLayerService.findAll(pageable);
