...
public class JornadaTrabalhoResource {
    ...
    public JornadaTrabalhoResource(JornadaTrabalhoService jornadaTrabalhoService) {
    ...
    public ResponseEntity<List<JornadaTrabalhoDTO>> getAllJornadaTrabalhos(Pageable pageable) {
        log.debug("REST request to get a page of JornadaTrabalhos");
        Page<JornadaTrabalhoDTO> page = jornadaTrabalhoService.findAll(pageable);
