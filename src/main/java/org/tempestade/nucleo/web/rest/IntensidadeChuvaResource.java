...
public class IntensidadeChuvaResource {
    ...
    public IntensidadeChuvaResource(IntensidadeChuvaService intensidadeChuvaService) {
    ...
    public ResponseEntity<List<IntensidadeChuvaDTO>> getAllIntensidadeChuvas(Pageable pageable) {
        log.debug("REST request to get a page of IntensidadeChuvas");
        Page<IntensidadeChuvaDTO> page = intensidadeChuvaService.findAll(pageable);
