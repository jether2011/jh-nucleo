...
public class VentoVmFaixaResource {
    ...
    public VentoVmFaixaResource(VentoVmFaixaService ventoVmFaixaService) {
    ...
    public ResponseEntity<List<VentoVmFaixaDTO>> getAllVentoVmFaixas(Pageable pageable) {
        log.debug("REST request to get a page of VentoVmFaixas");
        Page<VentoVmFaixaDTO> page = ventoVmFaixaService.findAll(pageable);
